                ...
                tickenDetail && (
                    ...
                    <div className={styles.header}>
                        <div className={styles.headerTitle}>
                            <img className={styles.headerIcon} src={tickenDetail.image} alt="icon" />
                            <div className={styles.headerDesc}>
                                <div className={styles.headerDescTitle}>{tickenDetail.name}</div>
                                <div className={styles.headerDescText}>{tickenDetail.description}</div>
                            </div>
                        </div>
