  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.summary}>
        Ticken is a ticket tool product that combines NFT social play.
        Here.
      </div>
      <div className={styles.list}>
        <ul>
          <li className={styles.item}>Everyone can start an event</li>
          <li className={styles.item}>Each ticket is a unique NFT</li>
          <li className={styles.item}>Flexible configuration of different smart contracts, allowing events to quickly fracture</li>
          <li className={styles.item}>Customize the SBT of participating events to meet your multi-faceted role</li>
          <li className={styles.item}>Event data on the chain, leaving a good mark while allowing you to gain trust even in anonymity</li>
          <li className={styles.item}>Retrospective activities, no more regrets</li>
          <li className={styles.item}>Recommendation system to explore more activities and people that suit you</li>
        </ul>
      </div>
